...
class Control(object):
    ...
    # 角度值
    degree_yaw_s1   = 1400  # 1000-1400-1800
    degree_yaw_s5   = 1400  # 1000-1400-2000
    degree_pitch_s3 = 1200  #  800-1200-1600
    degree_pitch_s2 = 1200  #  800-1200-1600
    ...
    def update_degrees(self, Message: int, Position: (int, int), Wheel: int, is_show=False):
        if Message == 519: # 如果检测到按滚轮
            ...
            if self.flag_wheel_on:      # 按滚轮，更新舵机值S1 S2
                ...
                self.degree_pitch_s2 = 1200 + Position[1] - self.position_y
        ...
        # 限幅
        self.degree_yaw_s1 = min(1800, self.degree_yaw_s1)
        self.degree_yaw_s1 = max(1000, self.degree_yaw_s1)
        self.degree_yaw_s5 = max(1000, self.degree_yaw_s5)
        self.degree_yaw_s5 = min(2000, self.degree_yaw_s5)
        self.degree_pitch_s2 = max( 800, self.degree_pitch_s2)
        self.degree_pitch_s2 = min(1600, self.degree_pitch_s2)
