...
logger.debug('[DLIB] Detector Loading ......')
detector = dlib.simple_object_detector("detector.svm")
logger.debug('[DLIB] Detector Load Finished.')
...
if __name__ == "__main__":
    ...
    while True:
        ...
        for (k, d) in enumerate(rects):
            print("[DLIB] Detection {}: Left: {} Top: {} Right: {} Bottom: {}".format(
